...
class MainMenu(Entity):
    def __init__(self, player, floating_islands, deserted_sands):
        super().__init__(
            parent = camera.ui
        )
        ...
        self.start_button = Button(text = "Start", color = colourH, highlight_color = colourH, scale_y = 0.1, scale_x = 0.3, y = 0.07, parent = self.mainmenu)
        ...
        self.main_overlay = Entity(parent = self.mainmenu, model = "quad", scale = 0, eternal = True, z = 10)
        self.no_buttion = Button(text = "#--Survive For At Least For 2 Minutes--#", color = colourH, highlight_color = colourH, scale_y = 0.1, scale_x = 0.7, y = 0.45, parent = self.mainmenu)
        self.no_buttion = Button(text = "For Instruction Press [I]", color = colourH, scale_y = 0.1, scale_x = 0.4, y = 0.20, parent = self.mainmenu)
        self.no_button = Button(text = "Press Enter Key To Select Highlited Button", color = colourH, highlight_color = colourH, scale_y = 0.1, scale_x = 0.7, y = 0.33, parent = self.mainmenu)
        text = Text("Tip-Do Not Fell From The Land!", scale = 1, origin = (0, 0.5), x = -0.6, y = 0.4, z = -50, parent = self.mainmenu) 
       

        invoke(setattr, self.start_button, "color", colourH, delay = 0.5)

        # Endscreen
        retry_text = Text("Game-Over", scale = 4, origin = (0, 0.5), x = 0, y = 0.1, z = -100, parent = self.end_screen)
        press_enter = Text("Player Died", scale = 2, origin = (0, 0.5), x = 0, y = 0, z = -100, parent = self.end_screen)
        ...
        camera.overlay.color = color.rgba(0, 0, 0)     
        # Pause Menu
       
        self.resume_button = Button(text = "Resume", color = colourN, highlight_color = colourN, scale_y = 0.1, scale_x = 0.3, y = 0.07, parent = self.pause_menu)
        ...
        self.pause_overlay = Entity(parent = self.pause_menu, model = "quad", scale = 99, color = color.rgba(0, 0, 0, 0), eternal = True, z = 10)
        self.no_button = Button(text = "#--Beat The High Score--#", color = colourH, highlight_color = colourH, scale_y = 0.1, scale_x = 0.7, y = 0.45, parent = self.pause_menu)
        self.no_button = Button(text = "To Select Any Highlighted Button Press Enter", color = colourH, highlight_color = colourH, scale_y = 0.1, scale_x = 0.7, y = 0.33, parent = self.pause_menu)
        self.no_button = Button(text = "For Instruction Press [I]", color = colourH, highlight_color = colourH, scale_y = 0.1, scale_x = 0.5, y = 0.20, parent = self.pause_menu)
        text = Text("Tip-Do Not Fell From The Land!", color = color.rgb(1, 1, 1), scale = 1, origin = (0, 0.5), x = -0.6, y = 0.4, z = -50, parent = self.pause_menu)
